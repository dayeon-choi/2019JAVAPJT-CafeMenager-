...
public class CafeTest {
	...
	SimpleDateFormat format2 = new SimpleDateFormat ("Mdd");
	...
	/* 메인화면 메뉴 버튼 정의 */
	JButton MenuBtn_01 = new JButton(menu[0].getMenuName());
	JButton MenuBtn_01_ = new JButton(menu[0].getMenuPrice()+"원");
	JButton MenuBtn_02 = new JButton(menu[1].getMenuName());
	JButton MenuBtn_02_ = new JButton(menu[1].getMenuPrice()+"원");
	JButton MenuBtn_03 = new JButton(menu[2].getMenuName());
	JButton MenuBtn_03_ = new JButton(menu[2].getMenuPrice()+"원");
	JButton MenuBtn_04 = new JButton(menu[3].getMenuName());
	JButton MenuBtn_04_ = new JButton(menu[3].getMenuPrice()+"원");
	JButton MenuBtn_05 = new JButton(menu[4].getMenuName());
	JButton MenuBtn_05_ = new JButton(menu[4].getMenuPrice()+"원");
	JButton MenuBtn_06 = new JButton(menu[5].getMenuName());
	JButton MenuBtn_06_ = new JButton(menu[5].getMenuPrice()+"원");
	JButton MenuBtn_07 = new JButton(menu[6].getMenuName());
	JButton MenuBtn_07_ = new JButton(menu[6].getMenuPrice()+"원");
	JButton MenuBtn_08 = new JButton(menu[7].getMenuName());
	JButton MenuBtn_08_ = new JButton(menu[7].getMenuPrice()+"원");
	JButton MenuBtn_09 = new JButton(menu[8].getMenuName());
	JButton MenuBtn_09_ = new JButton(menu[8].getMenuPrice()+"원");
	JButton MenuBtn_10 = new JButton(menu[9].getMenuName());
	JButton MenuBtn_10_ = new JButton(menu[9].getMenuPrice()+"원");
	JButton MenuBtn_11 = new JButton(menu[10].getMenuName());
	JButton MenuBtn_11_ = new JButton(menu[10].getMenuPrice()+"원");
	JButton MenuBtn_12 = new JButton(menu[11].getMenuName());
	JButton MenuBtn_12_ = new JButton(menu[11].getMenuPrice()+"원");
	
	
	/* 메인화면에 보여지는 메뉴 버튼 텍스트 새로고침 */
	public void resetingShowingMenu() {
			MenuBtn_01.setText(menu[0].getMenuName());
			MenuBtn_01_.setText(menu[0].getMenuPrice()+"원");
			MenuBtn_02.setText(menu[1].getMenuName());
			MenuBtn_02_.setText(menu[1].getMenuPrice()+"원");
			MenuBtn_03.setText(menu[2].getMenuName());	
			MenuBtn_03_.setText(menu[2].getMenuPrice()+"원");
			MenuBtn_04.setText(menu[3].getMenuName());
			MenuBtn_04_.setText(menu[3].getMenuPrice()+"원");
			MenuBtn_05.setText(menu[4].getMenuName());
			MenuBtn_05_.setText(menu[4].getMenuPrice()+"원");
			MenuBtn_06.setText(menu[5].getMenuName());
			MenuBtn_06_.setText(menu[5].getMenuPrice()+"원");
			MenuBtn_07.setText(menu[6].getMenuName());
			MenuBtn_07_.setText(menu[6].getMenuPrice()+"원");
			MenuBtn_08.setText(menu[7].getMenuName());
			MenuBtn_08_.setText(menu[7].getMenuPrice()+"원");
			MenuBtn_09.setText(menu[8].getMenuName());
			MenuBtn_09_.setText(menu[8].getMenuPrice()+"원");
			MenuBtn_10.setText(menu[9].getMenuName());
			MenuBtn_10_.setText(menu[9].getMenuPrice()+"원");
			MenuBtn_11.setText(menu[10].getMenuName());
			MenuBtn_11_.setText(menu[10].getMenuPrice()+"원");
			MenuBtn_12.setText(menu[11].getMenuName());
			MenuBtn_12_.setText(menu[11].getMenuPrice()+"원");	
	}//end of method
	...
	public void resetingMenuTable() {
		for(int i=0; i<menuLength; i++) {
			...
			menuData[i][1] = menu[i].getMenuPrice()+"원";
		}
	}//end of method
	...
	public void deletetempMenuSet() {
		for(int i=0; i< Order.ordermenuLength; i++) {
			tempMenu[i] = "";
			tempQuantity[i] = 0;
			tempPayprice = 0;
		}
	...
	public void payOrder() {
		...
		for(int i=0; i<orderLength; i++) {
			...
			if(order[i].isFilled() == false) {
				...
				/*결제 완료 메시지*/
				JOptionPane.showMessageDialog(null, "주문번호"+(tmpODRnum)+": "+messg,"결제 완료",JOptionPane.PLAIN_MESSAGE);
	...
	public void showEarnings() {
		...
		for(int i=0; i<LastRecords.recordsIndex; i++) {
			...
			orderData_last[i][1] = record[i].getEarnings_record()+"원";
			orderData_last[i][2] = record[i].getSales_record()+"건";
	...
	public void resetEarnings() {
		...
		if(record[LastRecords.recordsIndex-1].getDate() != "") { //저장할 빈 자리가 없으면
			...
			LastRecords temp;
			for(int i=0; i<LastRecords.recordsIndex-1; i++) {
		...
		for(int i=0; i<LastRecords.recordsIndex; i++) {
			if(record[i].getDate().equals("")) {
				...
				String formatdate = timeInfo;
				String snowEarnings = Integer.toString(nowEarnings);
				String snowPays = Integer.toString(nowPays);
				addLastRecords_DB = new addLastRecords_DB(sid,formatdate, snowEarnings, snowPays);
	...
	private void Main() {
		...
		/* 메뉴 버튼 정의 */
		MenuBtn_01.addActionListener(new ActionListener() {
		...
		MenuBtn_01.setBackground(new Color(255, 192, 203));
		MenuBtn_01.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_01.setBounds(17, 45, 164, 44);
		square.add(MenuBtn_01);
		
		MenuBtn_02.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		...
		MenuBtn_02.setBackground(new Color(255, 192, 203));
		MenuBtn_02.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_02.setBounds(191, 45, 164, 44);
		square.add(MenuBtn_02);
		
		MenuBtn_03.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_03.setBackground(new Color(255, 192, 203));
		MenuBtn_03.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_03.setBounds(365, 45, 164, 44);
		square.add(MenuBtn_03);
		
		MenuBtn_04.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_04.setBackground(new Color(255, 192, 203));
		MenuBtn_04.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_04.setBounds(17, 136, 164, 44);
		square.add(MenuBtn_04);
		MenuBtn_05.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_05.setBackground(new Color(255, 192, 203));
		MenuBtn_05.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_05.setBounds(191, 136, 164, 44);
		square.add(MenuBtn_05);
		
		MenuBtn_06.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_06.setBackground(new Color(255, 192, 203));
		MenuBtn_06.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_06.setBounds(365, 136, 164, 44);
		square.add(MenuBtn_06);
		
		MenuBtn_07.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_07.setBackground(new Color(255, 192, 203));
		MenuBtn_07.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_07.setBounds(17, 227, 164, 44);
		square.add(MenuBtn_07);
		
		MenuBtn_08.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_08.setBackground(new Color(255, 192, 203));
		MenuBtn_08.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_08.setBounds(191, 227, 164, 44);
		square.add(MenuBtn_08);
		
		MenuBtn_09.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_09.setBackground(new Color(255, 192, 203));
		MenuBtn_09.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_09.setBounds(365, 227, 164, 44);
		square.add(MenuBtn_09);
		
		MenuBtn_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_10.setBackground(new Color(255, 192, 203));
		MenuBtn_10.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_10.setBounds(17, 318, 164, 44);
		square.add(MenuBtn_10);
		
		MenuBtn_11.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_11.setBackground(new Color(255, 192, 203));
		MenuBtn_11.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_11.setBounds(191, 318, 164, 44);
		square.add(MenuBtn_11);
		
		MenuBtn_12.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		MenuBtn_12.setBackground(new Color(255, 192, 203));
		MenuBtn_12.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_12.setBounds(365, 318, 164, 44);
		square.add(MenuBtn_12);
		
		MenuBtn_02_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[1].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(1);
				}
		...
		MenuBtn_02_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_02_.setBackground(new Color(255, 192, 203));
		MenuBtn_02_.setBounds(191, 87, 164, 37);
		square.add(MenuBtn_02_);
		
		MenuBtn_01_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[0].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(0);
				}
		...
		MenuBtn_01_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_01_.setBackground(new Color(255, 192, 203));
		MenuBtn_01_.setBounds(17, 87, 164, 37);
		square.add(MenuBtn_01_);
		
		MenuBtn_03_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[2].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(2);
				}
		...
		MenuBtn_03_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_03_.setBackground(new Color(255, 192, 203));
		MenuBtn_03_.setBounds(365, 87, 164, 37);
		square.add(MenuBtn_03_);
		
		MenuBtn_04_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[3].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(3);
				}
		...
		MenuBtn_04_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_04_.setBackground(new Color(255, 192, 203));
		MenuBtn_04_.setBounds(17, 178, 164, 37);
		square.add(MenuBtn_04_);
		
		MenuBtn_05_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[4].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(4);
				}
		...
		MenuBtn_05_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_05_.setBackground(new Color(255, 192, 203));
		MenuBtn_05_.setBounds(191, 178, 164, 37);
		square.add(MenuBtn_05_);
		
		MenuBtn_06_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[5].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(5);
				}
		...
		MenuBtn_06_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_06_.setBackground(new Color(255, 192, 203));
		MenuBtn_06_.setBounds(365, 178, 164, 37);
		square.add(MenuBtn_06_);
		
		MenuBtn_07_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[6].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(6);
				}
		...
		MenuBtn_07_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_07_.setBackground(new Color(255, 192, 203));
		MenuBtn_07_.setBounds(17, 269, 164, 37);
		square.add(MenuBtn_07_);
		
		MenuBtn_08_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[7].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(7);
				}
		...
		MenuBtn_08_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_08_.setBackground(new Color(255, 192, 203));
		MenuBtn_08_.setBounds(191, 269, 164, 37);
		square.add(MenuBtn_08_);
		
		MenuBtn_09_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[8].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(8);
				}
		...
		MenuBtn_09_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_09_.setBackground(new Color(255, 192, 203));
		MenuBtn_09_.setBounds(365, 269, 164, 37);
		square.add(MenuBtn_09_);
		MenuBtn_10_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[9].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(9);
				}
		...
		MenuBtn_10_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_10_.setBackground(new Color(255, 192, 203));
		MenuBtn_10_.setBounds(17, 360, 164, 37);
		square.add(MenuBtn_10_);
		
		MenuBtn_11_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[10].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(10);
				}
		...
		MenuBtn_11_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_11_.setBackground(new Color(255, 192, 203));
		MenuBtn_11_.setBounds(191, 360, 164, 37);
		square.add(MenuBtn_11_);
		
		MenuBtn_12_.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(menu[11].getMenuName().equals("")==false) { //메뉴가 비어있지 않을때 임시주문정보에 저장
					pickMenu(11);
				}
		...
		MenuBtn_12_.setFont(new Font("굴림", Font.BOLD, 15));
		MenuBtn_12_.setBackground(new Color(255, 192, 203));
		MenuBtn_12_.setBounds(365, 360, 164, 37);
		square.add(MenuBtn_12_);
		...
		setIntoMenu_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				char tmp;
				for(int i=0; i<int_newMenuPrice.getText().length(); i++) {
		...
		/* 카피라이트 라벨 */
		JLabel copyrigth2 = new JLabel("\uC6F9\uC194 | 1305\uAE40\uBBFC\uC815 1318\uCD5C\uB2E4\uC5F0");
		copyrigth2.setFont(new Font("굴림", Font.PLAIN, 16));
		copyrigth2.setBounds(690, 465, 227, 18);
		deleteMenuBar.add(copyrigth2);
		...
		/* 카피라이트 라벨 */
		JLabel copyright = new JLabel("2019 \uBBF8\uB9BC\uB9C8\uC774\uC2A4\uD130 10\uAE30");
		copyright.setFont(new Font("굴림", Font.PLAIN, 16));
		copyright.setBounds(735, 440, 172, 28);
		deleteMenuBar.add(copyright);
		JLabel copyright3 = new JLabel("\u24D2\uC81C\uC791");
		copyright3.setFont(new Font("굴림", Font.PLAIN, 16));
		copyright3.setBounds(855, 420, 58, 18);
		deleteMenuBar.add(copyright3);
		...
		reMenuBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				/*입력받은 가격이 숫자가 맞는지 판별*/
				char tmp;
				for(int i=0; i<reMenuPriceField.getText().length(); i++) {
		...
		/* 주문 정보 삭제 라벨 */
		JLabel lblNo = new JLabel("\uC0AD\uC81C\uD560 \uC8FC\uBB38\uC815\uBCF4 NO.");
		...
		btn_del_order.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(order[(int)(spinner.getValue())-1].isFilled()==true) {//해당 주문정보가 있으면
					for(int i=0; i<orderLength; i++) { //값을 찾아 삭제
						if((int)spinner.getValue()==order[i].getOrdernum()) {
							order[i].deleteOrder();
						}
					}
					JOptionPane.showMessageDialog(null, spinner.getValue()+"번 주문정보를 삭제하였습니다.","주문 정보 삭제 완료",JOptionPane.INFORMATION_MESSAGE);
				}else { //해당 주문정보가 없으면
